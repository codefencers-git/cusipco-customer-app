...
class AboutPregnancyTestScreen extends StatefulWidget {
  final String id;
  final String mode;
  const AboutPregnancyTestScreen({
    Key? key,
    required this.id,
    required this.mode,
  }) : super(key: key);
  ...
  @override
  State<AboutPregnancyTestScreen> createState() => _AboutPregnancyTestScreenState();
}

class _AboutPregnancyTestScreenState extends State<AboutPregnancyTestScreen> {

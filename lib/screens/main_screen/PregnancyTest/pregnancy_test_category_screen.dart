...
class PregnancyTestCategoryScreen extends StatefulWidget {
  const PregnancyTestCategoryScreen({Key? key}) : super(key: key);

  @override
  State<PregnancyTestCategoryScreen> createState() => _PregnancyTestCategoryScreenState();
}

class _PregnancyTestCategoryScreenState extends State<PregnancyTestCategoryScreen> {
  @override
  void initState() {
    Provider.of<PregnancyTestService>(context, listen: false)
  ...
  Widget build(BuildContext context) {
    final model = Provider.of<PregnancyTestService>(context);
      ...
      child: SafeArea(
        ...
        appBar: PreferredSize(
            ...
            child: AppBarWithTextAndBackWidget(
              ...
              title: "Pregnancy Test Categories",
              isShowCart: true,
            )),
        body: Container(

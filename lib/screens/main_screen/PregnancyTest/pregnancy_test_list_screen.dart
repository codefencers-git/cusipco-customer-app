...
class PregnancyTestListScreen extends StatefulWidget {
  PregnancyTestListScreen({Key? key, required this.categoryId, required this.mode})
      : super(key: key);
  final String categoryId;

  final String mode;
  @override
  State<PregnancyTestListScreen> createState() => _PregnancyTestListScreenState();
}

class _PregnancyTestListScreenState extends State<PregnancyTestListScreen>

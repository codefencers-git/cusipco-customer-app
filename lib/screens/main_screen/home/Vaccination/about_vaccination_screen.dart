...
class AboutVaccinationScreen extends StatefulWidget {
  final String id;
  final String mode;
  const AboutVaccinationScreen({
    Key? key,
    required this.id,
    required this.mode,
  }) : super(key: key);
  ...
  @override
  State<AboutVaccinationScreen> createState() => _AboutVaccinationScreenState();
}

class _AboutVaccinationScreenState extends State<AboutVaccinationScreen> {

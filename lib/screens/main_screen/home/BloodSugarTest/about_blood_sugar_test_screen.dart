...
class AboutBloodSugarTestScreen extends StatefulWidget {
  final String id;
  final String mode;
  const AboutBloodSugarTestScreen({
    Key? key,
    required this.id,
    required this.mode,
  }) : super(key: key);
  ...
  @override
  State<AboutBloodSugarTestScreen> createState() => _AboutBloodSugarTestScreenState();
}

class _AboutBloodSugarTestScreenState extends State<AboutBloodSugarTestScreen> {

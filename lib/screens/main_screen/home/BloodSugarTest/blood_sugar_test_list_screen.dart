...
class BloodSugarTestListScreen extends StatefulWidget {
  BloodSugarTestListScreen({Key? key, required this.categoryId, required this.mode})
      : super(key: key);
  final String categoryId;

  final String mode;
  @override
  State<BloodSugarTestListScreen> createState() => _BloodSugarTestListScreenState();
}

class _BloodSugarTestListScreenState extends State<BloodSugarTestListScreen>

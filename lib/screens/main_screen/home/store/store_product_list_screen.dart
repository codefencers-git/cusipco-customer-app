...
class StoreproductListScreen extends StatefulWidget {
  ...
  @override
  State<StoreproductListScreen> createState() => _FitnessShopScreenState();
}

class _FitnessShopScreenState extends State<StoreproductListScreen>
  ...
  List<StoreProductListData>? _productData = [];
  ...
  Future<void> getProductData(bool isInit) async {
    ...
    try {
      ...
      if (response.statusCode == 200 || response.statusCode == 201) {
        ...
        StoreProductListModel data = StoreProductListModel.fromJson(body);
    ...
    return Padding(
      ...
      child: InkWell(
        onTap: () {
          ...
          pushNewScreen(
            context,
            screen: StoreProductDetailsScreen(
                ...
                Expanded(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(
                        _productData![index].variation.toString(),
                        // "asd",
                        style: TextStyle(
                            overflow: TextOverflow.ellipsis,
                            fontSize: 12,

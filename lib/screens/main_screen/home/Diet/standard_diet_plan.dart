...
import 'package:cusipco/screens/main_screen/home/Diet/select_diet_plan_screen.dart';
...
import 'package:cusipco/widgets/text_boxes/text_box_normal.dart';
import 'package:intl/intl.dart';
import 'package:persistent_bottom_nav_bar/persistent-tab-view.dart';
import 'package:provider/provider.dart';

class StanderdDietPlanScreen extends StatefulWidget {
  StanderdDietPlanScreen({Key? key, this.title, required this.type})
      : super(key: key);
  ...
  @override
  State<StanderdDietPlanScreen> createState() => _StanderdDietPlanScreenState();
}

class _StanderdDietPlanScreenState extends State<StanderdDietPlanScreen> {
...
//!  variables for  anycomorbidilities
  ...
  _addDiet() async {
    ...
    var _dietlist = await getDietPlan();

    if (_dietlist == null && _dietlist!.isEmpty) {
      showToast("There Is No Diet Plan.");
      return;
    }
    setState(() {
      _isLoading = false;
    ...
    var _dietPlan = _dietlist.where((element) => element.id.toString() == "1");
    if (_dietPlan.isEmpty) {
      showToast("There Is No Diet Plan.");
      return;
    }

    print(_dietPlan.first.title);

    //
    // calculate tax 18%
    double _price = double.parse(_dietPlan.first.price.toString());
    ...
    var res = await pushNewScreen(
      ...
      screen: CheckoutForOtherScreen(
        moduleView: 3,
        tax: _tax.toString(),
        dietPlan: _dietPlan.first,
        chanrges: _dietPlan.first.price.toString(),
                    ...
                    child: Form(
                      ...
                      child: Column(
                          ...
                          children: [
                            ...
                            // widget.type != "Unconfirmed"
                            //     ? _buildtitle("Diet required")
                            //     : SizedBox(),
                            // widget.type != "Unconfirmed"
                            //     ? _buildDietRequired()
                            //     : SizedBox(),

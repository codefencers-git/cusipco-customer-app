...
class CovidTestListScreen extends StatefulWidget {
  CovidTestListScreen({Key? key, required this.categoryId, required this.mode})
      : super(key: key);
  final String categoryId;

  final String mode;
  @override
  State<CovidTestListScreen> createState() => _CovidTestListScreenState();
}

class _CovidTestListScreenState extends State<CovidTestListScreen>

...
class AboutCovidTestScreen extends StatefulWidget {
  final String id;
  final String mode;
  const AboutCovidTestScreen({
    Key? key,
    required this.id,
    required this.mode,
  }) : super(key: key);
  ...
  @override
  State<AboutCovidTestScreen> createState() => _AboutCovidTestScreenState();
}

class _AboutCovidTestScreenState extends State<AboutCovidTestScreen> {

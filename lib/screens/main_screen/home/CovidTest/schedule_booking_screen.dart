...
class ScheduleCheckupBooking extends StatefulWidget {
  final String id;
  final DoctorDetailsModel? doctorDetailsModel;
  final String mode;

  const ScheduleCheckupBooking({
    Key? key,
    required this.mode,
  ...
  @override
  State<ScheduleCheckupBooking> createState() => _ScheduleCheckupBookingState();
}

class _ScheduleCheckupBookingState extends State<ScheduleCheckupBooking> {

...
class CovidTestCategoryScreen extends StatefulWidget {
  const CovidTestCategoryScreen({Key? key}) : super(key: key);

  @override
  State<CovidTestCategoryScreen> createState() => _CovidTestCategoryScreenState();
}

class _CovidTestCategoryScreenState extends State<CovidTestCategoryScreen> {
  @override
  void initState() {
    Provider.of<CovidTestService>(context, listen: false)
  ...
  Widget build(BuildContext context) {
    final model = Provider.of<CovidTestService>(context);

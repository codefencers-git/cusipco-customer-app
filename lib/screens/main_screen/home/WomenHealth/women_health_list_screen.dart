...
class WomenHealthListScreen extends StatefulWidget {
  WomenHealthListScreen({Key? key, required this.categoryId, required this.mode})
      : super(key: key);
  final String categoryId;

  final String mode;
  @override
  State<WomenHealthListScreen> createState() => _WomenHealthListScreenState();
}

class _WomenHealthListScreenState extends State<WomenHealthListScreen>

...
class WomenHealthCategoryScreen extends StatefulWidget {
  const WomenHealthCategoryScreen({Key? key}) : super(key: key);

  @override
  State<WomenHealthCategoryScreen> createState() => _WomenHealthCategoryScreenState();
}

class _WomenHealthCategoryScreenState extends State<WomenHealthCategoryScreen> {
  @override
  void initState() {
    Provider.of<WomenHealthCategoryProvider>(context, listen: false)
  ...
  Widget build(BuildContext context) {
    final model = Provider.of<WomenHealthCategoryProvider>(context);
      ...
      child: SafeArea(
        ...
        appBar: PreferredSize(
            ...
            child: AppBarWithTextAndBackWidget(
              ...
              title: "Women's Health (OBG) Categories",
              isShowCart: true,
            )),
        body: Container(
